...
#y_train = y[(y == 0) | (y == 1) | (y == 2)]
#x_train = x[np.where((y == 0) | (y == 1) | (y == 2))]
...
#              optimizer=Adam(lr=0.1, beta_1=0.9, beta_2=0.999, epsilon=10**-8, decay=0.9),
#              metrics=["accuracy"])
#model.fit(x, y_train_ot, batch_size=128, epochs=2, validation_data=(x_test,y_test_ot), verbose=1)
model.fit(x_train, y_train_ot, batch_size=1, epochs=10, verbose=1)
